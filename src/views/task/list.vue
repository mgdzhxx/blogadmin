<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="任务ID" width="130px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="参数" align="center" width="120">
        <template slot-scope="{row}">
          <el-button type="info" size="mini" @click="handleDetail(row.param)">
            点击查看详情
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog title="任务参数" :visible.sync="taskDialogFormVisible" width="650px">
      <div>
        <pre>{{ taskParams }}</pre>
      </div>
    </el-dialog>
...
<script>
import { GetTaskList, updateMineInfo } from '@/api/mine'
...
export default {
  ...
  methods: {
    ...
    handleDetail(params) {
      ...
      this.taskParams = JSON.stringify(JsonStr, undefined, 2)
